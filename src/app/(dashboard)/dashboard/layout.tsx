    ...
    <div className="w-full flex h-screen">
      <div className="md:hidden">
        <MobileChatLayout
          ...
          unseenRequestCount={unseenRequests}
        />
      </div>
      <div
        className="hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200
      bg-white px-6"
      >
                    ...
                    <li key={option.id}>
                      ...
                      >
                        <span
                          ...
                          group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border 
      ...
      <aside className="max-h-screen py-16 container md:py-12 w-full">
        {children}
      </aside>
    </div>
  );
